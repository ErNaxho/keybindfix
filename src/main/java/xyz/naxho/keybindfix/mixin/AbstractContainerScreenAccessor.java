 ...
 *   <li>{@code slotClicked(Slot, int, int, ClickType)} (Yarn:
 *       {@code onMouseClick}): el mismo método que ejecuta un click de
 *       ratón real sobre un slot.</li>
 * </ul>
...
public interface AbstractContainerScreenAccessor {
    ...
    @Invoker("slotClicked")
    void keybindfix$invokeOnMouseClick(Slot slot, int slotId, int button, ClickType actionType);
}
